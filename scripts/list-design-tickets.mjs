#!/usr/bin/env node
/**
 * Liste les tickets Notion taggés "Design" et au statut "À faire".
 *
 * Variables d'env requises :
 *   NOTION_TOKEN       -> clé de l'intégration interne Notion
 *   NOTION_TASK_PAGE_ID -> ID de la data source (database) des tickets
 */
...
const TAG_VALUE = "Design";
const STATUS_PROPERTY = "Statut";
const STATUS_TODO_VALUE = "À faire";

if (!NOTION_API_KEY || !NOTION_DB_ID) {
  console.error("Erreur: NOTION_TOKEN et NOTION_TASK_PAGE_ID doivent être définis.");
  process.exit(1);
}
